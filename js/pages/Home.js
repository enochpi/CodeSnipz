function HomePage(props) {
    const featuredProjects = pythonScripts.filter(p => p.featured);
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                            ...
                            <Button size="lg" variant="outline" onClick={() => props.onNavigate('about')} className="px-8 py-3">
                                Learn More
                            </Button>
                        </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mt-12">
                        <Button size="lg" variant="outline" onClick={() => props.onNavigate('projects')} className="px-8">
                            View All Projects
                            <ArrowRight className="w-5 h-5 ml-2" />
                        </Button>
                    </div>
